    ...
    <div class="row justify-content-center mt-5">
        <div class="col-md-5">
            <div class="card">
                ...
                <form action="{{ route('admin.expense.update', $expense) }}" method="POST" class="card-body border border-danger">
                    @csrf
                    @method('PUT')
                    <div class="form-group">
                        <input type="text" name="category"
                            class="form-control px-4 py-2 @error('category') is-invalid @enderror"
                            placeholder="Your Category" value="{{ $expense->category }}">
                    </div>
                    <div class="row mt-2">
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="date" name="date"
                                    ...
                                    placeholder="Your Category" value="{{ $expense->date }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group mt-2">
                        <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="5"
                            placeholder="Description">{{ $expense->description }}</textarea>
                    </div>
