<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form action="{{ route('admin.expense.store') }}" method="POST" class="modal-content border border-2 border-danger">
            @csrf
            <div class="modal-header bg-danger">
                <h1 class="modal-title fs-4 text-light" id="exampleModalLabel">
                    <i class="bi bi-dash-square pe-2"></i>
                    <span>Added New Expense</span>
                </h1>
